%%
%该程序用来提取全国台站中指定站号的数据（地表温度）
%%
clc;clear;
%var initialization
selectStationId=51463
inputFilePath='..\..\originalData\SURF_CLI_CHN_MUL_FTM_H4-dvd-6\datasets\GST\';
inputFileNameHead='SURF_CLI_CHN_MUL_FTM_H4-GST-12030-0cm-';
outputFilePath='..\..\stationsData\GST_H4\';
